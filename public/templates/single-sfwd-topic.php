    ...
    <div class="info_wrapp">
        <div class="thumbnail">
            ...
            <div class="tab-content">
				...
				<input type="text" name="bitwisescr-note-title" id="bitwisescr-note-titlenew" value="<?php if(isset($oldnotes[0]->title)){ echo $oldnotes[0]->title;}else{echo get_the_title(); }?>" placeholder="">
				</div>
				<?php
				...
				<li><a href="javascript:void(0)" class="bitwisescr-notes-print-shortcode" data-note="<?php the_ID(); ?>" title="<?php echo 'Print'; ?>"><i class="fa fa-print" aria-hidden="true"></i></a><div id="learndash-print-notes-new"></div></li>
				
				<?php  if(isset($oldnotes[0]->content)){?>
				<li><a href="javascript:void(0)"   class="downloadword" data-note="<?php echo $oldnotes[0]->id; ?>" title="<?php echo 'Download'; ?>"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a></li>
